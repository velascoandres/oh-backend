        ...
        DataBaseModule.forBulkData(
            {
                ...
                creationOrder: 3,
                pathDev: '/src/sis-modules/user-profile-role/test-data/user-profile.development.json',
                pathProd: '/dist/sis-modules/user-profile-role/test-data/user-profile.production.json',
                connection: 'default',
            },
        ),
    ],
